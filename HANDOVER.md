...
**2026-08-14、v0.5.0としてコミット・push・リリース予定**。v0.4.1の続きのセッションで、新規ブロック`classloadout:guard_spawner`を追加(OP専用GUIで指定エンティティの監視・自動復活・持ち物設定ができるブロック)。詳細は下記「2026-08-14セッションのまとめ」節を参照。以後の変更は再びこのセクションで追跡すること。
...
- v0.5.0: 新規ブロック`classloadout:guard_spawner`(OP専用GUIで指定エンティティの監視・自動復活・持ち物設定)を含む最新の正式リリース(2026-08-14、上記「2026-08-14セッションのまとめ」参照)
